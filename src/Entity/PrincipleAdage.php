...
use App\Repository\PrincipleAdageRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Table(name="principesEtAdages")
 * @ORM\Entity(repositoryClass=PrincipleAdageRepository::class)
 */
class PrincipleAdage
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
